    ...
    <div className="min-h-screen bg-[#0d0810] text-foreground font-inter flex">
      ...
      <main className="flex-1 lg:ml-80 xl:ml-96 2xl:ml-96">
        ...
        <a
          ...
          className="fixed top-5 right-6 z-40 hidden lg:flex items-center gap-2 px-4 py-2 rounded-full border border-fuchsia-500/25 bg-white/4 backdrop-blur-sm hover:border-fuchsia-400/50 hover:bg-fuchsia-500/8 transition-all duration-200 group"
        >
          <svg viewBox="0 0 24 24" width="16" height="16" fill="url(#gh-grad)" className="opacity-70 group-hover:opacity-100 transition-opacity flex-shrink-0">
            <defs>
          ...
          <span className="font-mono text-xs tracking-wide" style={{
            background: "linear-gradient(90deg, #e879f9, #a855f7, #ec4899, #8b5cf6)",
